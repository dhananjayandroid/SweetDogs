...
object FakeDataProvider {
    ...
    val fakeDogResponse1 = DogResponse(
        ...
        id = 1,
        image = Image(height = 500, id = "abc123", url = "https://example.com/pug.jpg", width = 500),
    ...
    val fakeDogResponse2 = DogResponse(
        ...
        id = 2,
        image = Image(height = 600, id = "def456", url = "https://example.com/beagle.jpg", width = 600),
        life_span = "12 - 15 years",
        name = "Beagle",
        origin = "England",
